...
/*************************************************************************************************
  ...
  Added a foreign key constraint in the Country table that references the Capital of the Country
  This was added to simplyfy modeling with JPA-Entity Classes buildt from theese tables.
...
--****************************************************************************
-- Run script through MYSQLWorkbench, as it won't work in netbeans otherwise
--****************************************************************************
...
CREATE TABLE `Country` (
  ...
  PRIMARY KEY (`Code`),
  CONSTRAINT `capital_ibfk_1` FOREIGN KEY (`Capital`) REFERENCES `City` (`Id`)
